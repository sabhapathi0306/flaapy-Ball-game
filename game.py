...
game_image = {}
game_audio_sound = {}
player = 'gallery/sprites/ball.png'
bcg_image = 'gallery/sprites/backa.png'
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('CONTROL ME')
    game_image['numbers'] = (
    ...
    game_image['message'] = pygame.image.load('gallery/sprites/msg.png').convert_alpha()
    game_image['base'] = pygame.image.load('gallery/sprites/w1.png').convert_alpha()
    ...
    # Game sounds
    game_audio_sound['die'] = pygame.mixer.Sound('gallery/audio/die.wav')
    game_audio_sound['hit'] = pygame.mixer.Sound('gallery/audio/hit.wav')
    game_audio_sound['point'] = pygame.mixer.Sound('gallery/audio/point.wav')
    game_audio_sound['swoosh'] = pygame.mixer.Sound('gallery/audio/swoosh.wav')
    game_audio_sound['wing'] = pygame.mixer.Sound('gallery/audio/wing.wav')
